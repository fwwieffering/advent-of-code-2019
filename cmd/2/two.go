...
var input = `1,0,0,3,1,1,2,3,1,3,4,3,1,5,0,3,2,10,1,19,1,19,6,23,2,13,23,27,1,27,13,31,1,9,31,35,1,35,9,39,1,39,5,43,2,6,43,47,1,47,6,51,2,51,9,55,2,55,13,59,1,59,6,63,1,10,63,67,2,67,9,71,2,6,71,75,1,75,5,79,2,79,10,83,1,5,83,87,2,9,87,91,1,5,91,95,2,13,95,99,1,99,10,103,1,103,2,107,1,107,6,0,99,2,14,0,0`

// Two prints the answers for day 2 of advent of code
...
// Once you have a working computer, th first step is to restore the gravity assist program (your puzzle input) to the "1202 program alarm" state it had just before the last computer caught fire. To do this, before running the program, replace position 1 with the value 12 and replace position 2 with the value 2. What value is left at position 0 after the program halts?
var Two = &cobra.Command{
	Use:   "two",
	Short: "runs advent of code day 2 https://adventofcode.com/2019/day/2",
	Run:   two,
}
...
func two(cmd *cobra.Command, args []string) {
	...
	if found {
		logger.Infof("(part two): Inputs: %d, %d. Answer: %d", a, b, 100*a+b)
	} else {
		logger.Infof("(part two): couldn't find answer :(")
	}
}
